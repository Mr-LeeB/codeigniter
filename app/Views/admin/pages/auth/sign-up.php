      ...
      <div class="row">
        <div
          ...
          <div
            ...
            style="background-image: url('<?= base_url("assets/img/illustrations/illustration-signup.jpg") ?>'); background-size: cover;">
          </div>
        </div>
          ...
          <div class="card card-plain">
            ...
            <div class="card-footer text-center pt-0 px-lg-2 px-1">
              <p class="mb-2 text-sm mx-auto">
                ...
                <a href="<?= base_url('admin/auth/login'); ?>" class="text-primary text-gradient font-weight-bold">Sign
                  in</a>
              </p>
            </div>
          </div>
